...
function NavbarBig({ clickLogout }) {
    ...
    return (
        <div className={`${styles._navbar}`}>
            <div className={`${styles._navbar_brand}`}>
                <NavHashLink to="/" className={`${styles._navbar_brand_link}`}>
                    <Heading text="Abacus'22"/>
                </NavHashLink>
            </div>
  ...
  activeStyle={{ color: '#ff2483' }}>
                ...
                {Auth ?
                    ...
                    <NavHashLink to="" className={`${styles._navbar_main_link}`} onClick={clickLogout} activeClassName="selected"
  activeStyle={{ color: '#ff2483' }}>
