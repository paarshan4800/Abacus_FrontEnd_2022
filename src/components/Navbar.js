  ...
  return (
    <div className={`${styles._navbar}`}>
      ...
      <div className={`${styles._navbar_main}`}>
        <Link
          className={`${styles._navbar_main_link}`}
          to="/"
        ...
        {Auth ? (
          <>
            <Link
              ...
              activeStyle={{ color: "#ff2483" }}
            >
              <span className={`${styles._navbar_main_link_text}`}>
                Dashboard
              </span>
            </Link>
            <Link
    ...
    <nav role="navigation">
      <div className={styles1.menuToggle}>
        ...
        <ul className={styles1.menu}>
          <Link to="/" onClick={closeNavBarOnClick}>
            <li>Home</li>
          </Link>
          <Link to="/aboutus" onClick={closeNavBarOnClick}>
            <li>About us</li>
          </Link>
          <Link to="/events" onClick={closeNavBarOnClick}>
            {" "}
            <li>Events</li>
          </Link>
          <Link to="/workshops" onClick={closeNavBarOnClick}>
            <li>Workshops</li>
          </Link>
          {Auth ? (
            <>
              <Link to="/dashboard" onClick={closeNavBarOnClick}>
                <li>Dashboard</li>
              </Link>
              <Link
                to="#"
            ...
            <>
              <Link to="/login" onClick={closeNavBarOnClick}>
                <li>Login</li>
              </Link>
            </>
          )}
...
*/
  return (
    <>
      {width < 1350 ? (
        <NavbarSmall clickLogout={clickLogout} />
      ) : (
        <NavbarBig clickLogout={clickLogout} />
      )}
    </>
  );
}
